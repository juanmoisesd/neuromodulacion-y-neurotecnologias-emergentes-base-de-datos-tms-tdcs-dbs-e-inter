# Neuromodulación y Neurotecnologías Emergentes: Base de Datos TMS, tDCS, DBS e Interfaces Cerebro-Computadora
...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.18881128.svg)](https://doi.org/10.5281/zenodo.18881128)
...
[![Pages](https://img.shields.io/badge/Live-Microsite-brightgreen)](https://juanmoisesd.github.io/neuromodulacion-y-neurotecnologias-emergentes-base-de-datos-tms-tdcs-dbs-e-inter/)

## Overview
Repositorio de bases de datos, registros y repositorios sobre neuromodulación y neurotecnologías emergentes: estimulación magnética transcraneal (TMS), estimulación transcraneal por corriente directa (tDCS), estimulación cerebral profunda (DBS), interfaces cerebro-computadora (BCI), y resultados cognitivos, clínicos y neurofisiológicos asociados. Incluye: nombre completo, acrónimo, URL, año, insti

## Dataset Status
| Field | Value |
|---|---|
| Status | 🟢 Published |
| DOI | [10.5281/zenodo.18881128](https://doi.org/10.5281/zenodo.18881128) |
| Platform | Zenodo |
| License | CC0 1.0 |
| Published | 2026-03-05 |

## 🌐 Interactive Microsite
**[Open Microsite](https://juanmoisesd.github.io/neuromodulacion-y-neurotecnologias-emergentes-base-de-datos-tms-tdcs-dbs-e-inter/)**

## Keywords
neuromodulación, tDCS, TMS

## Citation
> de la Serna Tuya, J.M. (2026). *Neuromodulación y Neurotecnologías Emergentes: Base de Datos*. Zenodo. https://doi.org/10.5281/zenodo.18881128
...
**APA 7**
> De la Serna Tuya, J. M. (2025). *Repositorio de bases de datos, registros y repositorios sobre neuromodulación y neurotecnologías emergentes: estimulación magnética transcraneal (TMS), estimulación transcraneal por corriente directa (tDCS), estimulación cerebral profunda (DBS), inte* [Dataset]. GitHub. https://github.com/juanmoisesd/neuromodulacion-y-neurotecnologias-emergentes-base-de-datos-tms-tdcs-dbs-e-inter

**BibTeX**
```bibtex
@dataset{delaserna2025_neuromodulacion_y_neurotecnolo,
